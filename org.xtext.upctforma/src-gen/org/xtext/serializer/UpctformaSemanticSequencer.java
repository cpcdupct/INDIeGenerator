...
public class UpctformaSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == UpctformaPackage.eINSTANCE)
			...
			case UpctformaPackage.CONTENT_UNIT:
				sequence_ContentUnit(context, (ContentUnit) semanticObject); 
				return; 
			...
			case UpctformaPackage.NUMBER:
				sequence_Number(context, (upctforma.Number) semanticObject); 
				return; 
	...
	/**
	 * Contexts:
	 *     ContentElement returns Literal
	...
	protected void sequence_Literal(ISerializationContext context, Literal semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UpctformaPackage.Literals.LITERAL__LITERAL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UpctformaPackage.Literals.LITERAL__LITERAL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getLiteralAccess().getLiteralEStringParserRuleCall_2_0(), semanticObject.getLiteral());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     ContentElement returns Number
	 *     Number returns Number
	 *
	 * Constraint:
	 *     num=EInt
	 */
	protected void sequence_Number(ISerializationContext context, upctforma.Number semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UpctformaPackage.Literals.NUMBER__NUM) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UpctformaPackage.Literals.NUMBER__NUM));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getNumberAccess().getNumEIntParserRuleCall_2_0(), semanticObject.getNum());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=EString image=EString? title=EString? type=SectionType? (rows+=Row rows+=Row*)?)
	 */
	...
	protected void sequence_Text(ISerializationContext context, Text semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UpctformaPackage.Literals.TEXT__HTML) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UpctformaPackage.Literals.TEXT__HTML));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getTextAccess().getHtmlEStringParserRuleCall_2_1_0(), semanticObject.getHtml());
		feeder.finish();
	}
