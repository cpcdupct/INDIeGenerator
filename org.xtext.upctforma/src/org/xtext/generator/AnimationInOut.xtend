...
class AnimationInOut {
	...
	def List<String> generateAnimationInOut(Widget wg, String idgen, String title, List<ContentElement> args, int j, IFileSystemAccess2 fsa, String fileindex, String progresoobj, String fileanimationp, String fileanimationcssp, Integer tipo,List<String> language){
