...
public class UpctformaevaluaParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, UpctformaevaluaGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEvaluationLanguageTypeAccess().getAlternatives(), "rule__EvaluationLanguageType__Alternatives");
			...
			builder.put(grammarAccess.getEvaluationUnit_ImplAccess().getGroup_6(), "rule__EvaluationUnit_Impl__Group_6__0");
			builder.put(grammarAccess.getEvaluationUnit_ImplAccess().getGroup_6_3(), "rule__EvaluationUnit_Impl__Group_6_3__0");
			...
			builder.put(grammarAccess.getTrainingAccess().getGroup_8(), "rule__Training__Group_8__0");
			builder.put(grammarAccess.getTrainingAccess().getGroup_8_3(), "rule__Training__Group_8_3__0");
			...
			builder.put(grammarAccess.getFinalAccess().getGroup_6(), "rule__Final__Group_6__0");
			builder.put(grammarAccess.getFinalAccess().getGroup_6_3(), "rule__Final__Group_6_3__0");
			...
			builder.put(grammarAccess.getEvaluationUnit_ImplAccess().getLanguageAssignment_3(), "rule__EvaluationUnit_Impl__LanguageAssignment_3");
			builder.put(grammarAccess.getEvaluationUnit_ImplAccess().getNumberquestionsAssignment_5_1(), "rule__EvaluationUnit_Impl__NumberquestionsAssignment_5_1");
			builder.put(grammarAccess.getEvaluationUnit_ImplAccess().getQuestionsAssignment_6_2(), "rule__EvaluationUnit_Impl__QuestionsAssignment_6_2");
			builder.put(grammarAccess.getEvaluationUnit_ImplAccess().getQuestionsAssignment_6_3_1(), "rule__EvaluationUnit_Impl__QuestionsAssignment_6_3_1");
			...
			builder.put(grammarAccess.getTrainingAccess().getLanguageAssignment_3(), "rule__Training__LanguageAssignment_3");
			builder.put(grammarAccess.getTrainingAccess().getNumberquestionsAssignment_5_1(), "rule__Training__NumberquestionsAssignment_5_1");
			builder.put(grammarAccess.getTrainingAccess().getAttemptsAssignment_6_1(), "rule__Training__AttemptsAssignment_6_1");
			builder.put(grammarAccess.getTrainingAccess().getGradeAssignment_7_1(), "rule__Training__GradeAssignment_7_1");
			builder.put(grammarAccess.getTrainingAccess().getQuestionsAssignment_8_2(), "rule__Training__QuestionsAssignment_8_2");
			builder.put(grammarAccess.getTrainingAccess().getQuestionsAssignment_8_3_1(), "rule__Training__QuestionsAssignment_8_3_1");
			builder.put(grammarAccess.getFinalAccess().getNameAssignment_2(), "rule__Final__NameAssignment_2");
			builder.put(grammarAccess.getFinalAccess().getLanguageAssignment_3(), "rule__Final__LanguageAssignment_3");
			builder.put(grammarAccess.getFinalAccess().getNumberquestionsAssignment_5_1(), "rule__Final__NumberquestionsAssignment_5_1");
			builder.put(grammarAccess.getFinalAccess().getQuestionsAssignment_6_2(), "rule__Final__QuestionsAssignment_6_2");
			builder.put(grammarAccess.getFinalAccess().getQuestionsAssignment_6_3_1(), "rule__Final__QuestionsAssignment_6_3_1");
