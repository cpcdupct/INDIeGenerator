...
public class UpctformaPackageImpl extends EPackageImpl implements UpctformaPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getSection_Type(), this.getSectionType(), "type", null, 0, 1, Section.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(sectionTypeEEnum, SectionType.BACKGROUND_IMAGE);
		addEEnumLiteral(sectionTypeEEnum, SectionType.BACKGROUND_COLOUR);
